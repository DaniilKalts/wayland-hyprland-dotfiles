...
alias tree1='eza --tree --group-directories-first --sort=name --level=1'
alias tree2='eza --tree --group-directories-first --sort=name --level=2'
alias tree3='eza --tree --group-directories-first --sort=name --level=3'
alias tree4='eza --tree --group-directories-first --sort=name --level=4'
alias treea='eza --tree -a --group-directories-first --sort=name'
alias treea1='eza --tree -a --group-directories-first --sort=name --level=1'
alias treea2='eza --tree -a --group-directories-first --sort=name --level=2'
alias treea3='eza --tree -a --group-directories-first --sort=name --level=3'
alias treea4='eza --tree -a --group-directories-first --sort=name --level=4'
alias liatree='eza -la --icons --color=always --tree --group-directories-first --sort=name'
alias liatree1='eza -la --icons --color=always --tree --group-directories-first --sort=name --level=1'
alias liatree2='eza -la --icons --color=always --tree --group-directories-first --sort=name --level=2'
alias liatree3='eza -la --icons --color=always --tree --group-directories-first --sort=name --level=3'
alias liatree4='eza -la --icons --color=always --tree --group-directories-first --sort=name --level=4'
